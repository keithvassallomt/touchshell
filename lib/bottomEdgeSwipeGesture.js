...
export class BottomEdgeSwipeGesture extends EdgeSwipeGestureBase {
    constructor(settings, tabletMode) {
        ...
        // Touchup-equivalent feel: opening the overview commits in
        // ~60% of monitor height instead of a full screen height.
        this._driver = new OverviewGestureDriver({ distanceFactor: 0.6 });
