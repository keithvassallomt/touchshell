...
// Top-of-page AdwPreferencesGroup that holds only a description —
// keeps the page-level mental model visible without spending a row.
export function buildPageHeader(description) {
    return new Adw.PreferencesGroup({ description });
}
