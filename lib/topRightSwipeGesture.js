...
export class TopRightSwipeGesture {
    ...
    _openQuickSettings() {
        ...
        // If our own auto-hide is active the panel may be off-screen; snap
        // it to y=0 first so the menu's BoxPointer has a real on-screen
        // anchor. Auto-hide's own menu-state tracking keeps the panel
        // visible while the menu is open, and hides again on dismiss.
